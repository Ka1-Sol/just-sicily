      ...
      <div className="container-custom py-4">
        ...
        <div className="flex items-center justify-between relative">
          ...
          <div className="flex items-center space-x-6">
            ...
            {/* WhatsApp Icon */}
            <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-white hover:text-white/90">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
          ...
          {/* Linea bianca che si estende dal logo alla fine delle icone sociali */}
          <div className="absolute -bottom-2 left-0 right-0 h-[1px] bg-white/20"></div>
        </div>
      </div>
      ...
      >
        <div className="container-custom py-4">
          <nav className="flex flex-col space-y-4">
            ...
            <Link to="/travel-guide" className="text-white" onClick={() => setIsOpen(false)}>
              Travel Guide
            </Link>
          </nav>
        </div>
